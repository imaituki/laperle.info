<?php /* Smarty version Smarty-3.1.18, created on 2019-07-30 15:58:02
         compiled from "/home/jwcc/8071/html/admin/contents/shopping/template/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12112194145d0b2eb7c531c9-80328383%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97b1fdde64383731f0593335ec3efd6694479c62' => 
    array (
      0 => '/home/jwcc/8071/html/admin/contents/shopping/template/form.tpl',
      1 => 1564469875,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12112194145d0b2eb7c531c9-80328383',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5d0b2eb7db8133_15302865',
  'variables' => 
  array (
    'message' => 0,
    'arr_post' => 0,
...
<?php if ($_valid && !is_callable('content_5d0b2eb7db8133_15302865')) {function content_5d0b2eb7db8133_15302865($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_radios')) include '/home/jwcc/8071/data/smarty/libs/plugins/function.html_radios.php';
...
" />
		...
		<?php }?>
		<div class="form-group required">
			<label class="col-sm-2 control-label">商品詳細（一覧用）</label>
			<div class="col-sm-9">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label">商品詳細（ポップアップ用）</label>
			<div class="col-sm-9">
				<?php if ((($tmp = @$_smarty_tpl->tpl_vars['message']->value['ng']['detail'])===null||$tmp==='' ? '' : $tmp)!=null) {?><p class="error"><?php echo $_smarty_tpl->tpl_vars['message']->value['ng']['detail'];?>
</p><?php }?>
				<textarea name="detail" id="detail" rows="7" class="form-control ckeditor"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['arr_post']->value['detail'])===null||$tmp==='' ? '' : $tmp);?>
</textarea>
			</div>
		</div>
		<div class="hr-line-dashed"></div>
		<div class="form-group required">
			<label class="col-sm-2 control-label">税抜価格</label>
			<div class="col-sm-2">
				<?php if ((($tmp = @$_smarty_tpl->tpl_vars['message']->value['ng']['cost'])===null||$tmp==='' ? '' : $tmp)!=null) {?><p class="error"><?php echo $_smarty_tpl->tpl_vars['message']->value['ng']['cost'];?>
</p><?php }?>
				<div class="input-group">
					<input type="number" class="form-control" name="cost" id="cost" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['arr_post']->value['cost'])===null||$tmp==='' ? '' : $tmp);?>
" >
		...
		<div class="hr-line-dashed"></div>
		<div class="form-group required">
			<label class="col-sm-2 control-label">税込価格</label>
			<div class="col-sm-2">
				<?php if ((($tmp = @$_smarty_tpl->tpl_vars['message']->value['ng']['tax'])===null||$tmp==='' ? '' : $tmp)!=null) {?><p class="error"><?php echo $_smarty_tpl->tpl_vars['message']->value['ng']['tax'];?>
</p><?php }?>
				<div class="input-group">
					<input type="number" class="form-control" name="tax" id="tax" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['arr_post']->value['tax'])===null||$tmp==='' ? '' : $tmp);?>
" >
					<span class="input-group-addon">円</span>
				</div>
			</div>
		...
		<div class="hr-line-dashed"></div>
		<div class="form-group">
			<label class="col-sm-2 control-label">内容量</label>
			<div class="col-sm-6">
				<?php if ((($tmp = @$_smarty_tpl->tpl_vars['message']->value['ng']['weight'])===null||$tmp==='' ? '' : $tmp)!=null) {?><p class="error"><?php echo $_smarty_tpl->tpl_vars['message']->value['ng']['weight'];?>
</p><?php }?>
				<input type="text" class="form-control" name="weight" id="weight" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['arr_post']->value['weight'])===null||$tmp==='' ? '' : $tmp);?>
" />
			</div>
		</div>
		<div class="hr-line-dashed"></div>
		<div class="form-group">
			<label class="col-sm-2 control-label">ショッピングコード</label>
			<div class="col-sm-9">
				<?php if ((($tmp = @$_smarty_tpl->tpl_vars['message']->value['ng']['code'])===null||$tmp==='' ? '' : $tmp)!=null) {?><p class="error"><?php echo $_smarty_tpl->tpl_vars['message']->value['ng']['code'];?>
</p><?php }?>
				<textarea name="code" id="code" rows="7" class="form-control"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['arr_post']->value['code'])===null||$tmp==='' ? '' : $tmp);?>
</textarea>
			</div>
		</div>
		<div class="hr-line-dashed"></div>
